...
def save_image_with_boxes(image, boxes, logits, name, mode, risk_or_normal, save_path = None):
    fig, ax = plt.subplots()
    ax.imshow(image)
    ...
    for folder_name in folder_names:
        ...
        for img_name in tqdm(img_name_list):
            ...
            if len(masks) == 0:
                ...
                save_image_with_boxes(image_pil, boxes, logits, img_name, mode, risk_or_normal)
